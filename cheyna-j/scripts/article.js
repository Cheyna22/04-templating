...
Article.prototype.toHtml = function() {
  ...
  let template = $('#blogArticlesTemplate').html();
  console.log(template);
  let renderBlog = Handlebars.compile(template);
  ...
  return renderBlog(this);
};
    
// COMMENT: Why are there parentheses around "(a,b)" in the .sort() method, but not around the "articleObject" or "article" arguments in the .forEach() methods?
// We are putting parentheses around a,b because in an arrow function you need parentheses to pass in more than one parameter.
rawData.sort((a,b) => {
